app.config(function($stateProvider, $urlRouterProvider, $locationProvider) {
    ...
    $stateProvider
        ...
        .state('home.hangcu', {
            ...
            views: {
                "": {
                    templateUrl: 'app/components/hangcu/hangcuView.html',
                    controller: 'hangcuCtrl',
                }
            },
            access: true
        })
        .state('home.hangcucate', {
            url: "/hangcu/category/:id",
            views: {
                "": {
                    templateUrl: 'app/components/hangcu/hangcuCateView.html',
                    controller: 'hangcuCateCtrl',
                }
            },
            access: true
        })
